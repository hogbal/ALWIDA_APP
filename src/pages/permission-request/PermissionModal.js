        ...
        <View style={styles.modalContainer}>
          <View style={styles.contentsContainer}>
            <Text style={styles.text}>
              운송 서비스를 이용하려면 위치 권한을 허용해야합니다.
            </Text>
            <Text style={styles.descriptionText}>
              이 앱은 앱이 종료되었거나 사용 중이 아닐 때도 위치 데이터를
              수집하여 운송
            </Text>
            <Text style={styles.descriptionText}>
              구간 통과 확인, 목적지까지 남은 거리 및 시간 계산 기능을 사용
              설정합니다.
            </Text>
            <Text style={styles.descriptionText}></Text>
            <Text style={styles.descriptionText}>
              요청 화면이 나타나면 앱 사용 중에만 허용 - 설정 페이지 - 항상 허용
              설정해야
            </Text>
            <Text style={styles.descriptionText}>
              합니다. 설정하지 않은 경우 운송 서비스가 제대로 작동하지 않을 수도
              있습니다.
            </Text>
          </View>
